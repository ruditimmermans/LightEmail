...
import org.light.email.ActivityBase.IBackPressedListener
import org.light.email.AdapterMessage.IProperties
import org.light.email.AdapterMessage.ViewType
import org.light.email.BoundaryCallbackMessages.IBoundaryCallbackMessages
import org.light.email.databinding.FragmentMessagesBinding
...
class FragmentMessages : FragmentEx() {
    ...
    private fun loadMessages() {
        ...
        if (TextUtils.isEmpty(search)) {
            val prefs = PreferenceManager.getDefaultSharedPreferences(context)
            val sort = prefs.getString("sort", "time")
            val browse = prefs.getBoolean("browse", false)
