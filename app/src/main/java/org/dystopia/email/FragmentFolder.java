                        ...
                        protected Void onLoad(Context context, Bundle args) throws Throwable {
                            ...
                            try {
                                ...
                                if (folder != null) {
                                    ...
                                    db.folder()
                                        .setFolderProperties(id, name, display, hide, synchronize, unified, days);
                                    if (!synchronize) {
                    ...
                    public void onChanged(@Nullable final EntityFolder folder) {
                        ...
                        if (savedInstanceState == null) {
                            ...
                            etDisplay.setText(
                                folder == null
                                    ? null
                                    : (folder.display == null ? folder.name : folder.display));
                            ...
                            etAfter.setText(
                                Integer.toString(
                                    folder == null ? EntityFolder.DEFAULT_USER_SYNC : folder.after));
                        }
                        ...
                        ibDelete.setVisibility(
                            folder == null || !EntityFolder.USER.equals(folder.type)
                                ? View.GONE
                                : View.VISIBLE);
                    }
                });
