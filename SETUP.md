...
Setting up LightEmail is fairly simple.
...
Tap *Check* to let LightEmail connect to the email server and fetch a list of system folders.
...
If your provider supports [auto-discovery](https://tools.ietf.org/html/rfc6186), LightEmail will fill in the host name and port number,
...
If you want to lookup email addresses, have contact photos shown, etc, you'll need to grant read contacts permission to LightEmail.
...
If you want to receive new emails without delays, you should disable battery optimizations for LightEmail.
